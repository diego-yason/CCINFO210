...
VALUES
-- Software Technology
('CCPROG1', 'S11', 1, 99912345, 'O'),
('CCPROG1', 'S12', 1, 99945678, 'O'),
('CCPROG1', 'S13', 1, 99945679, 'O'),
('CCPROG1', 'S14', 1, 99989015, 'O'),
('CCPROG1', 'S15', 1, 99967892, 'O'),
('CCPROG2', 'S11', 1, 99912345, 'O'),
('CCPROG2', 'S12', 1, 99945678, 'O'),
('CCPROG2', 'S13', 1, 99945679, 'O'),
('CCPROG2', 'S14', 1, 99989015, 'O'),
('CCPROG2', 'S15', 1, 99967892, 'O'),
-- ...repeat for other courses in Software Technology...

-- Information Technology
('CCICOMP', 'S11', 1, 99923456, 'O'),
('CCICOMP', 'S12', 1, 99956780, 'O'),
('CCICOMP', 'S13', 1, 99978903, 'O'),
('CCICOMP', 'S14', 1, 99990126, 'O'),
('CCICOMP', 'S15', 1, 99923456, 'O'),
('CCINFOM', 'S11', 1, 99923456, 'O'),
('CCINFOM', 'S12', 1, 99956780, 'O'),
('CCINFOM', 'S13', 1, 99978903, 'O'),
('CCINFOM', 'S14', 1, 99990126, 'O'),
('CCINFOM', 'S15', 1, 99923456, 'O'),
-- ...repeat for other courses in Information Technology...

-- Computer Technology
('CTTECH1', 'S11', 1, 99934567, 'O'),
('CTTECH1', 'S12', 1, 99967891, 'O'),
('CTTECH1', 'S13', 1, 99901237, 'O'),
('CTTECH1', 'S14', 1, 99978903, 'O'),
('CTTECH1', 'S15', 1, 99934567, 'O'),
('CTTECH2', 'S11', 1, 99934567, 'O'),
('CTTECH2', 'S12', 1, 99967891, 'O'),
('CTTECH2', 'S13', 1, 99901237, 'O'),
('CTTECH2', 'S14', 1, 99978903, 'O'),
('CTTECH2', 'S15', 1, 99934567, 'O'),
-- ...repeat for other courses in Computer Technology...

-- Accountancy
('FNDACCT', 'S11', 1, 99956789, 'O'),
('FNDACCT', 'S12', 1, 99990125, 'O'),
('FNDACCT', 'S13', 1, 99934568, 'O'),
('FNDACCT', 'S14', 1, 99956789, 'O'),
('FNDACCT', 'S15', 1, 99990125, 'O'),
('FINACCT', 'S11', 1, 99956789, 'O'),
('FINACCT', 'S12', 1, 99990125, 'O'),
('FINACCT', 'S13', 1, 99934568, 'O'),
('FINACCT', 'S14', 1, 99956789, 'O'),
('FINACCT', 'S15', 1, 99990125, 'O'),
-- ...repeat for other courses in Accountancy...

-- Civil Engineering
('CIVL101', 'S11', 1, 99967890, 'O'),
('CIVL101', 'S12', 1, 99923460, 'O'),
('CIVL101', 'S13', 1, 99967890, 'O'),
('CIVL101', 'S14', 1, 99923460, 'O'),
('CIVL101', 'S15', 1, 99967890, 'O'),
('STRUCTA', 'S11', 1, 99967890, 'O'),
('STRUCTA', 'S12', 1, 99923460, 'O'),
('STRUCTA', 'S13', 1, 99967890, 'O'),
('STRUCTA', 'S14', 1, 99923460, 'O'),
('STRUCTA', 'S15', 1, 99967890, 'O'),
-- ...repeat for other courses in Civil Engineering...

-- Mechanical Engineering
('MECH101', 'S11', 1, 99978901, 'O'),
('MECH101', 'S12', 1, 99989013, 'O'),
('MECH101', 'S13', 1, 99912348, 'O'),
('MECH101', 'S14', 1, 99978901, 'O'),
('MECH101', 'S15', 1, 99989013, 'O'),
('THERMO1', 'S11', 1, 99978901, 'O'),
('THERMO1', 'S12', 1, 99989013, 'O'),
('THERMO1', 'S13', 1, 99912348, 'O'),
('THERMO1', 'S14', 1, 99978901, 'O'),
('THERMO1', 'S15', 1, 99989013, 'O'),
-- ...repeat for other courses in Mechanical Engineering...

-- Computer Engineering
('CMPENG1', 'S11', 1, 99989012, 'O'),
('CMPENG1', 'S12', 1, 99901235, 'O'),
('CMPENG1', 'S13', 1, 99989012, 'O'),
('CMPENG1', 'S14', 1, 99901235, 'O'),
('CMPENG1', 'S15', 1, 99989012, 'O'),
('CMPENG2', 'S11', 1, 99989012, 'O'),
('CMPENG2', 'S12', 1, 99901235, 'O'),
('CMPENG2', 'S13', 1, 99989012, 'O'),
('CMPENG2', 'S14', 1, 99901235, 'O'),
('CMPENG2', 'S15', 1, 99989012, 'O'),
-- ...repeat for other courses in Computer Engineering...

-- Electrical Engineering
('INTROEE', 'S11', 1, 99990123, 'O'),
('INTROEE', 'S12', 1, 99912347, 'O'),
('INTROEE', 'S13', 1, 99990123, 'O'),
('INTROEE', 'S14', 1, 99912347, 'O'),
('INTROEE', 'S15', 1, 99990123, 'O'),
('CIRCSEE', 'S11', 1, 99990123, 'O'),
('CIRCSEE', 'S12', 1, 99912347, 'O'),
('CIRCSEE', 'S13', 1, 99990123, 'O'),
('CIRCSEE', 'S14', 1, 99912347, 'O'),
('CIRCSEE', 'S15', 1, 99990123, 'O'),
-- ...repeat for other courses in Electrical Engineering...

-- Entrepreneurship
('ENTREP1', 'S11', 1, 99901234, 'O'),
('ENTREP1', 'S12', 1, 99923458, 'O'),
('ENTREP1', 'S13', 1, 99901234, 'O'),
('ENTREP1', 'S14', 1, 99923458, 'O'),
('ENTREP1', 'S15', 1, 99901234, 'O'),
('ENTREP2', 'S11', 1, 99901234, 'O'),
('ENTREP2', 'S12', 1, 99923458, 'O'),
('ENTREP2', 'S13', 1, 99901234, 'O'),
('ENTREP2', 'S14', 1, 99923458, 'O'),
('ENTREP2', 'S15', 1, 99901234, 'O'),
-- ...repeat for other courses in Entrepreneurship...

-- Marketing
('FNDMRKT', 'S11', 1, 99912346, 'O'),
('FNDMRKT', 'S12', 1, 99934569, 'O'),
('FNDMRKT', 'S13', 1, 99912346, 'O'),
('FNDMRKT', 'S14', 1, 99934569, 'O'),
('FNDMRKT', 'S15', 1, 99912346, 'O'),
('CONSUME', 'S11', 1, 99912346, 'O'),
('CONSUME', 'S12', 1, 99934569, 'O'),
('CONSUME', 'S13', 1, 99912346, 'O'),
('CONSUME', 'S14', 1, 99934569, 'O'),
('CONSUME', 'S15', 1, 99912346, 'O'),
-- ...repeat for other courses in Marketing...

-- Law
('INTRO2L', 'S11', 1, 99923457, 'O'),
('INTRO2L', 'S12', 1, 99945680, 'O'),
('INTRO2L', 'S13', 1, 99923457, 'O'),
('INTRO2L', 'S14', 1, 99945680, 'O'),
('INTRO2L', 'S15', 1, 99923457, 'O'),
('CONSTIL', 'S11', 1, 99923457, 'O'),
('CONSTIL', 'S12', 1, 99945680, 'O'),
('CONSTIL', 'S13', 1, 99923457, 'O'),
('CONSTIL', 'S14', 1, 99945680, 'O'),
('CONSTIL', 'S15', 1, 99923457, 'O'),
-- ...repeat for other courses in Law...

-- Education
('WELEDUC', 'S11', 1, 99934568, 'O'),
('WELEDUC', 'S12', 1, 99945681, 'O'),
('WELEDUC', 'S13', 1, 99934568, 'O'),
('WELEDUC', 'S14', 1, 99945681, 'O'),
('WELEDUC', 'S15', 1, 99934568, 'O'),
('EDUPSYC', 'S11', 1, 99934568, 'O'),
('EDUPSYC', 'S12', 1, 99945681, 'O'),
('EDUPSYC', 'S13', 1, 99934568, 'O'),
('EDUPSYC', 'S14', 1, 99945681, 'O'),
('EDUPSYC', 'S15', 1, 99934568, 'O'),
-- ...repeat for other courses in Education...

-- Lab Courses
('LBSCRUM', 'S11', 1, 99912345, 'O'),
('LBSCRUM', 'S12', 1, 99945678, 'O'),
('LBSCRUM', 'S13', 1, 99945679, 'O'),
('LBSCRUM', 'S14', 1, 99989015, 'O'),
('LBSCRUM', 'S15', 1, 99967892, 'O'),
('LBDEPLY', 'S11', 1, 99912345, 'O'),
('LBDEPLY', 'S12', 1, 99945678, 'O'),
('LBDEPLY', 'S13', 1, 99945679, 'O'),
('LBDEPLY', 'S14', 1, 99989015, 'O'),
('LBDEPLY', 'S15', 1, 99967892, 'O');
